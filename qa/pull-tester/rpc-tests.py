...
#Set env vars
buildDir = BUILDDIR
if "GINCOIND" not in os.environ:
    os.environ["GINCOIND"] = buildDir + '/src/gincoind' + EXEEXT
if "GINCOINCLI" not in os.environ:
    os.environ["GINCOINCLI"] = buildDir + '/src/gincoin-cli' + EXEEXT
