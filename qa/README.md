...
Every pull request to the Gincoin Core repository is built and run through
...
```
  ...
  --srcdir=SRCDIR       Source directory containing gincoind/gincoin-cli
                        (default: ../../src)
...
blocks (25*500=12500 GIN) in its wallet.
