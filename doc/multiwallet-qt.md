...
Only requiring some minor changes is gincoin.cpp.
...
Changes to gincoin.cpp
----------------------
gincoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
