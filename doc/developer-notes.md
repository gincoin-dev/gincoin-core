...
Gincoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 10111.
...
However, in open source software such as Gincoin Core, where everyone uses
...
pay attention to for reviewers of Gincoin Core code.

General Gincoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Gincoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
