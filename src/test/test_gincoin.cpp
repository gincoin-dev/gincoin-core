...
#define BOOST_TEST_MODULE Gincoin Test Suite

#include "test_gincoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_gincoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
